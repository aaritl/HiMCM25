...
Additional Note: Some of the figures (the graphs) were just isolated from the original data table, and aren't showing up for some reason (if using google colab it will more than likely show up).
